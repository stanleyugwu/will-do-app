...
function toggleSearchbox() {
    ...
    if ($(box).width() == '0') {
        $(box).css('width', '58%');
        $('.mdi-magnify').addClass('mdi-magnify-close')
        $('.searchbox input').focus();
        $(box).toggleClass('animated swing')
    } else {
        $(box).css('width', '0');
        $('.mdi-magnify-close').removeClass('mdi-magnify-close')
    }
}
...
function toggleSortMenu() {
    ...
    $('.sort-menu').toggleClass('animated swing')
}
...
function toggleAddForm() {
    ...
    if (addBtn.classList.contains('mdi-plus-circle')) {
        ...
        addBtn.className = "mdi mdi-minus-circle";
    } else {
        addBtn.className = 'mdi mdi-plus-circle';
        $(addBtn).css('transform', 'rotate(-360deg)')
