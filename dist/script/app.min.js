...
window.onload = function() {
    ...
    if (db.length == 0) {
        ...
        $('main.main-content').html(
            '<h2 style="display:block;width:100%;color:orange;text-align:center;clear:both">NOTHING TO DO!!</h2><h1 style="color:orange;font-size:6rem;text-align:center;"><i class ="mdi mdi-emoticon-frown"></i></h1><i style="text-align:center;color:orange;font-size:3rem;margin:5rem auto;display:block;" class="mdi mdi-arrow-down-bold"></i>'
        );
        $('.sort-pane').hide();
    }
}
